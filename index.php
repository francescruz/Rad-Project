<?php
$coords = "51.5286416,-0.1015987"; //Change this to the latitude and longitude of the place you want the tweets to come from
...
function toggleDiv(objid){
	...
	if(objid.getElementsByTagName("p")[0]) objid.getElementsByTagName("p")[0].style.paddingRight = "220px";
